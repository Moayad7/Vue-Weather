<template>
  <div id="app" :class="typeof weather.main != 'undefined' && weather.main.temp > 290 ? 'warm' : ''">
    <main>
      ...
      <div class="weather-app" v-if="typeof weather.main != 'undefined'">
        ...
        <div class="weather-box">
          <div class="temp">{{ Math.round(convert(weather.main.temp)) }}° C</div>
...
export default {
  ...
  data(){
    return{
      api_key: '3ce3d0be92a24a9b1fedb1bbcdcbcc52',
  ...
  methods:{
    ...
    convert(tempreture){
      return this.tempreture = tempreture - 273;
    }
  }
}
</script>
